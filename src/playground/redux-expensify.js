...
//what does timestamp 0 represent. --> January 1st 1970 (unix epoch)
//33400 for exasmple is 33 seconds after the above date (unix epoch)
...
store.dispatch(sortByAmount()); //when sortbyamount gets dispatched, the sortby prperty should be set to amount
//store.dispatch(sortByDate()); //when sorbydate gets dispatched the sortby property should be set to date
...
const demoState ={
  expenses: [{
    ...
    amount: 54500,//sticking with pennies here $545.00
    createdAt: 0
  }],
  filters: {
    text: 'rent',
